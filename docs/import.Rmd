...
```{r readr-ExOffndrsRaw}
raw_inst_folder <- paste0("../data/raw/", noquote(lubridate::today()), "/")
fs::dir_create(
    raw_inst_folder
  )
...
ExecutedOffenders <- readr::read_rds(
  file = "../data/raw/2022-11-21/ExecutedOffenders.rds")
```
...
# fs::dir_create("../data/2022-11-21/")
# readr::write_rds(Links, file = "../data/2022-11-21/Links.rds")
